...
{
    /// <summary>
    /// The Greedy Best-First Graph Search Crawler
    /// </summary>
    /// <seealso cref="SokobanSolver.Models.GreBeFTSCrawler" />
    public class GreBeFGSCrawler : GreBeFTSCrawler
    {
        // The Explored or "Closed" set
        public List<BaseNode> ExploredSet = new List<BaseNode>();

        /// <summary>
        /// Initializes a new instance of the <see cref="GreBeFGSCrawler"/> class.
        /// </summary>
        /// <param name="map">The map.</param>
        /// <param name="mapDims">The map dims.</param>
        /// <param name="startingCoord">The starting coord.</param>
        public GreBeFGSCrawler(char[,] map, int[] mapDims, int[] startingCoord, List<int[]> crates, List<int[]> targets) : base(map, mapDims, startingCoord, crates, targets)
        {
        }
